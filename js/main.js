// --- Active section highlighting for top nav (desktop) ---
...
// --- Intake form behavior (intake.html) ---
...
intakeForm?.addEventListener("submit", (e) => {
  ...
  if (formStatus){
    formStatus.textContent = "Request submitted (demo). To receive submissions by email, connect a backend later.";
  }
  intakeForm.reset();
  updateStorageVisibility();
});

// --- Footer policy modals (full text as before) ---
...
const policies = {
  privacy: {
    ...
    body: `
      ...
      <h4>10. Contact</h4>
      <p>Company: PrepNest NY LLC, Brooklyn, NY</p>
